...
if __name__ == "__main__":
    ...
    model_7_path = r"ensemble_model\model_7.pth" # Valid Loss : 0.692 | Public Score : 0.73300
    ...
    model_6 = Net6().to(device)
    model_6.load_state_dict(torch.load(model_6_path))

    model_7 = Net7().to(device)
    model_7.load_state_dict(torch.load(model_7_path))
    ...
    with torch.no_grad(): 
        for data in tqdm(test_loader): 
            ...
            # Ensemble : Averaging
            avg_pred = (pred_1 + pred_3 + pred_6 + pred_7) / 4
